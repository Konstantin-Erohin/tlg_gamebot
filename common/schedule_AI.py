...
ВАЖНО: Игра считается общей ТОЛЬКО если она ЕСТЬ в списке КАЖДОГО участника группы.
Не учитывай регистр при сравнении, а название игры должно совпадать на 50% и более.

Правила:
1. Сначала определи, кто свободен в каждый день
2. Затем найди игры, которые есть у НАИБОЛЬШЕГО числа участников
3. Игра должна быть в списке КАЖДОГО участника группы
4. Если у всех участников дня нет общих игр, покажи всех участников, но укажи "Нет общих игр"
5. Если есть группа из 2+ участников с общими играми, покажи ТОЛЬКО их
